...
$JAVA_HOME/bin/java -cp $WEB_APP_CLASSPATH org.apache.axis.client.AdminClient -lhttp://localhost:8080/$SERVICE_NAME/services/AdminService deploy_nodeagent.wsdd
