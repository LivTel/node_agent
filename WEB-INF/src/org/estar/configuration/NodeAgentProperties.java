package org.estar.configuration;
...
public class NodeAgentProperties extends Properties{
	...
	public static final String GLS_USE 																	= "gls.use"; 
	public static final String GLS_HOST 																	= "gls.host"; 
	public static final String GLS_PORT																	= "gls.port"; 
	public static final String GLS_CHANNEL_ERROR												= "gls.channel.error"; 
	public static final String GLS_CHANNEL_TRACE												= "gls.channel.trace"; 
